...
var TimeDefaultPicker = (_temp = _class = function (_Component) {
  ...
  function TimeDefaultPicker() {
    ...
    return _possibleConstructorReturn(this, (TimeDefaultPicker.__proto__ || Object.getPrototypeOf(TimeDefaultPicker)).apply(this, arguments));
  }
  ...
  _createClass(TimeDefaultPicker, [{
    ...
    value: function onClickAway() {
      var _props = this.props,
          optOneArr = _props.optOneArr,
          format = _props.format,
          nowText = _props.nowText;
      var _state = this.state,
          value = _state.value,
          options = _state.options;

      var dates = this.setDateFormat(new Date(), 'yyyy/MM/dd hh:mm');
      var timestamp = new Date().getTime();
      var ondate = value[0];
      var onhour = value[1];
      var onminute = value[2];
      var setValArr = value;
      ...
      var fmt = new Date(dataString).getTime();
    ...
    value: function onChange(val, text, listIndex) {
      ...
      var _props2 = this.props,
          ...
          nowText = _props2.nowText;

      var days = options[0];
      var hours = options[1];
      var minutes = options[2];
      var setHours = hours;
    ...
    value: function setDateFormat(nowdate, fmt) {
      ...
      var deleytamp = isDelay ? new Date(nowdate).getTime() + 60 * 1000 * delay : new Date(nowdate).getTime();
    ...
    value: function _setInitHour(hour, isOnday) {
      ...
      var hourArr = isOnday ? [nowText] : [];
      var deleytamp = new Date().getTime() + 60 * 1000 * scale;
      var date = new Date(parseInt(deleytamp, 10));
      var dates = this.setDateFormat(date, 'yyyy/MM/dd hh:mm');
      var gethour = isOnday ? dates.datelist.h : hour;
