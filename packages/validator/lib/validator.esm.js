/*!
 * @pile-ui/validator.js v2.0.4-alpha.0
 * (c) 2018-2019 renmaomin <renmaomin@126.com> (https://github.com/renmm)
 * Released under the MIT License.
 */
import { createElement, Fragment, Component } from 'react';
import { bool, oneOfType, arrayOf, node, func, array, any, string } from 'prop-types';
...
function (_React$Component) {
  ...
  createClass(Validator, [{
    ...
    value: function render() {
      ...
      return createElement(Fragment, null, children(objectSpread({
        value: value,
        setValue: this._setValue,
        className: wrapCls
      }, nativeAttrs)), createElement(ErrorMessage, {
        show: showError
      }, checker.message));
    }
  }], [{
